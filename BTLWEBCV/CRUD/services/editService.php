<?php
    ...
    {
        global $conn;   
        $sql1 = "select * from service where id =" . $result;
    ...
    if (isset($_POST['btn-luu'])) {
        ...
        header('location: /CV_Project/adminpage/adminService.php');
    }
?>
<!doctype html>
<html lang="en">
  ...
  <body>
    <form action="editService.php" method="post">
        ...
        <a href="/CV_Project/adminpage/adminService.php" class="btn btn-default">Cancel</a>
