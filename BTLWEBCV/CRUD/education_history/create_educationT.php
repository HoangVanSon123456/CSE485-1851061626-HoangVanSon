...
<html lang="en">
      ...
      <body>
      <form action="create_educationT.php" class="needs-validation" method="post" novalidate>
         <h2 style = 'text-align:center'>Create New Course </h2>
        <div class="form-group">
            <label for="inputname"><strong>Name</strong></label>
            <input type="name" class="form-control" id="name" name="name" placeholder="Enter your course name" required>
            <div class="invalid-feedback">Please enter a valid name to continue.</div>
        </div>
        <div class="form-group">
            <label for="inputcontent"><strong>Content</strong></label>
            <input type="content" class="form-control" id="content" name="content" placeholder="Enter your course content" required>
          ...
          <div class="form-group">
            ...
            <input type="year" class="form-control" id="year_start" name="year_start" placeholder="Enter your start year" required>
