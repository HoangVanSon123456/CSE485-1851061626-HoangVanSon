<?php
    ...
    {
        global $conn;   
        $sql1 = "select * from achievement where id =" . $result;
    ...
    if (isset($_POST['btn-luu'])) {
        ...
        $sql3 = "update achievement set  
        name='$name', 
        parameter='$parameter'
        where id='$id'";  
        //print_r($sql3);
        mysqli_query($conn, $sql3);
        header('location: adminAchievement.php');
    }
?>
<!doctype html>
<html lang="en">
  ...
  <body>
    <form action="editAchievement.php" method="post">
        ...
        <a href="adminAchievement.php" class="btn btn-default">Hủy bỏ</a>
