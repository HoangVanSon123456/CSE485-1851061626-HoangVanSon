         ...
         if($result = mysqli_query($conn, $sql)){
            ...
            echo "<table class='table table-striped'>";
                echo "<div class='dropdown'>";
                    echo "<a class='btn-top' style='margin-right: 15px;text-align: right' href='/CV_Project/CRUD/skills/createSkills.php' class='btn btn-primary btn-success'> <span class='glyphicon glyphicon-plus'></span> &nbsp Create Table</a>";
                echo "</div>";
                echo "<thead>";
                ...
                while($row = mysqli_fetch_array($result)){
                    echo "<tr class='ow-content'>";
                        ...
                        echo "<td>";
                            echo "<a class='btn btn-danger edit' href='/CV_Project/CRUD/skills/deleteSkills.php?id=".$row['id']."' aria-label='Settings'>
                               <i class='fa fa-trash' aria-hidden='true '></i></a>";
                            echo "&nbsp";
                            echo "<a class='btn btn-info edit ' href='/CV_Project/CRUD/skills/editSkills.php?id=".$row['id']."' aria-label='Settings'>
                                <i class='fa fa-pencil-square-o ' aria-hidden='true '></i></a> ";
                            echo "&nbsp";
                            echo "<a class='btn btn-success edit ' href='/CV_Project/CRUD/skills/readSkills.php?id=".$row['id']."' aria-label='Settings'>
