INSERT INTO `personal_information`(`Name`, `Age`, `Address`, `Email`, `Username`, `Pass`, `Carrer`, `Phone`, `Description`,`Get_in_touch`, `Image`) 
...
Sincerely Thank you!','');
INSERT INTO `personal_information`(`Name`, `Age`, `Address`, `Email`, `Carrer`, `Phone`, `Description`, `Image`) 
...
INSERT INTO `skill`(`ID_skill`, `Name`, `Parameter`) 
VALUES ('1','HTML','75%'),
('2','CSS','65%'),
('3','PHP','60%'),
('4','JAVASCRIPT','80%');
...
INSERT INTO `achievement`(`ID_achievement`, `Name`, `Parameter`) 
VALUES ('1','WORKS COMPLETED','45'),
('2','MONTHS OF EXPERIENCE','15'),
('3','TOTAL CLIENTS','100'),
('4','AWARDS WON','10');

INSERT INTO `service_list`(`ID_service`, `Services_name`, `Decription`,`ID_personal`) 
...
INSERT INTO `job_history`(`ID_job`, `Name`, `Content`, `ID_personal`) VALUES 
...
INSERT INTO `education_history`(`ID_eduation`, `Name`, `Content`, `Year_start`, `Course_time`) VALUES 
