INSERT INTO `user`(`name`, `age`, `address`, `email`, `username`, `password`, `carrer`, `phone`, `description`,`get_in_touch`, `image`) 
...
Sincerely Thank you!','');
INSERT INTO `user`(`name`, `age`, `address`, `email`, `ccarrer`, `phone`, `description`, `image`) 
