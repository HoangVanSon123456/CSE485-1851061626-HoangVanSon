...
<html lang="en">
  ...
  <form action="edit_teamT.php" class="needs-validation" method="post" novalidate>
        <h2 style = 'text-align:center'>Edit Partner information</h2>
        ...
        <div class="form-group">
            ...
            <input type="content" class="form-control" id="description" name="description" value="<?php echo $description ?>">
