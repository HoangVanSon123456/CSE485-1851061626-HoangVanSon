...
<html lang="en">
      ...
      <body>
      <form action="create_teamT.php" class="needs-validation" method="post" novalidate>
         <h2 style = 'text-align:center'>Create New Partner </h2>
        <div class="form-group">
            <label for="inputname"><strong>Name</strong></label>
            <input type="name" class="form-control" id="name" name="name" placeholder="Enter your partner name" required>
            <div class="invalid-feedback">Please enter a valid name to continue.</div>
        </div>
        <div class="form-group">
            <label for="inputcontent"><strong>Content</strong></label>
            <input type="content" class="form-control" id="description" name="description" placeholder="Enter your partner description" required>
