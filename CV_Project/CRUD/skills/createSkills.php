<?php
      ...
      if (isset($_POST['btn-submit'])) 
      {
        ...
        {
          $sql2 = "insert into skills (name,parameter) values
          ('$name','$parameter')" ;
          mysqli_query($conn, $sql2);
          header('location: /adminpage/adminSkills.php');
          exit();
        }
    }
?>
...
<div class="bs-example">
    <form action="createSkills.php" class="needs-validation" method="post" novalidate>
         <h2>Create Skills</h2>
        ...
        <a href="/adminpage/adminSkills" class="btn btn-default">Cancel</a>
        </div>
