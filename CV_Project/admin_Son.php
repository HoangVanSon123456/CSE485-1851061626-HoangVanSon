...
<body>
    ...
    <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
        ...
        <ul class="nav menu">
            <li><a href="#about"><em class="fa fa-dashboard">&nbsp;</em>About Me</a></li>
            <li><a href="#resume"><em class="fa fa-calendar">&nbsp;</em>Resume</a></li>
            <li class="#team"><a href="charts.html"><em class="fa fa-bar-chart">&nbsp;</em> Charts</a></li>
            <li><a href="#work"><em class="fa fa-toggle-off">&nbsp;</em> UI Elements</a></li>
    ...
    <?php
        ...
        echo"<h1 style='color: #448aff;text-align: center;'>User Information</h1>";
        //1. Kết nối database
        ...
        echo"<div class=dropdown'>";
            echo"<a class='btn-top' style='margin-right: 15px;text-align: right' href='create_education.php' class='btn btn-primary btn-success'> <span class='glyphicon glyphicon-plus'></span> &nbsp Create Table</a>";
        echo"</div>";
        // echo"</div>";
        echo"<br>";
        echo"<thead>";
        ...
        foreach($users as $user)
        {
            ...
            echo "<td>$user[4]</td>";
            echo "<td>";
            echo "<a class='btn btn-success edit ' href='read_education.php?id=".$user[0]."' aria-label='Settings '>
                <i class='fa fa-eye' aria-hidden='true'></i></a> ";
            echo "&nbsp";
            echo "<a class='btn btn-info edit ' href='edit_education.php?id=".$user[0]."' aria-label='Settings '>
                <i class='fa fa-pencil-square-o ' aria-hidden='true '></i></a> ";
            echo "<a class='btn btn-danger edit' href='delete_education.php?id=".$user[0]."' aria-label='Settings'>
