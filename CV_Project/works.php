        ...
        <section id="work" class="portfolio-mf sect-pt4 route">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="work-box">
                            <a href="resources/img/background.jpg" data-gall="portfolioGallery" class="venobox">
                                <div class="work-img">
                                    <img src="resources/img/background.jpg" alt="" class="img-fluid">
                                </div>
                            </a>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <!-- ion-ios-plus-outline -->
                                            <a href="work_detail.php"> <span class="fas fa-eye"></span></a>
                                            <a href="work_detail.php"> <span class="fas fa-edit"></span></a>
                                            <a href="work_detail.php"> <span class="fas fa-trash-alt"></span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="container">
                ...
                <div class="owl-carousel testimonials-carousel">
                    ...
                    <div class="testimonial-item" data-aos="fade-up">
                        ...
                        <img src="assets/image/background.jpg" class="testimonial-img" alt="">
                        <h3>Saul Goodman</h3>
                        <h4>Ceo &amp; Founder</h4>
                    </div>
